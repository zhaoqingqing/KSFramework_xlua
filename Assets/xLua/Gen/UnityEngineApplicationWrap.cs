...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineApplicationWrap
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(typeof(UnityEngine.Application), L, __CreateInstance, 15, 32, 4);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "stackTraceLogType", _g_get_stackTraceLogType);
            ...
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "stackTraceLogType", _s_set_stackTraceLogType);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_stackTraceLogType(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
			    translator.Push(L, UnityEngine.Application.stackTraceLogType);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_stackTraceLogType(RealStatePtr L)
        {
            ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
            try {
			UnityEngine.StackTraceLogType __cl_gen_value;translator.Get(L, 1, out __cl_gen_value);
				UnityEngine.Application.stackTraceLogType = __cl_gen_value;
