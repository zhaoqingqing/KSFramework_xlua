...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineKeyCodeWrap
    {
		public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginClassRegister(typeof(UnityEngine.KeyCode), L, null, 323, 0, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.KeyCode));
    ...
    public class UnityEngineRuntimePlatformWrap
    {
		public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginClassRegister(typeof(UnityEngine.RuntimePlatform), L, null, 34, 0, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "OSXWebPlayer", UnityEngine.RuntimePlatform.OSXWebPlayer);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "OSXDashboardPlayer", UnityEngine.RuntimePlatform.OSXDashboardPlayer);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "WindowsWebPlayer", UnityEngine.RuntimePlatform.WindowsWebPlayer);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "XBOX360", UnityEngine.RuntimePlatform.XBOX360);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "PS3", UnityEngine.RuntimePlatform.PS3);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "WP8Player", UnityEngine.RuntimePlatform.WP8Player);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "BlackBerryPlayer", UnityEngine.RuntimePlatform.BlackBerryPlayer);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.RuntimePlatform));
			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
				...
				else if (LuaAPI.xlua_is_eq_str(L, 1, "OSXWebPlayer"))
                {
                    translator.PushUnityEngineRuntimePlatform(L, UnityEngine.RuntimePlatform.OSXWebPlayer);
                }
				...
				else if (LuaAPI.xlua_is_eq_str(L, 1, "WindowsWebPlayer"))
                {
                    translator.PushUnityEngineRuntimePlatform(L, UnityEngine.RuntimePlatform.WindowsWebPlayer);
                }
				...
				else if (LuaAPI.xlua_is_eq_str(L, 1, "XBOX360"))
                {
                    translator.PushUnityEngineRuntimePlatform(L, UnityEngine.RuntimePlatform.XBOX360);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "PS3"))
                {
                    translator.PushUnityEngineRuntimePlatform(L, UnityEngine.RuntimePlatform.PS3);
                }
				...
				else if (LuaAPI.xlua_is_eq_str(L, 1, "WP8Player"))
                {
                    translator.PushUnityEngineRuntimePlatform(L, UnityEngine.RuntimePlatform.WP8Player);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "BlackBerryPlayer"))
                {
                    translator.PushUnityEngineRuntimePlatform(L, UnityEngine.RuntimePlatform.BlackBerryPlayer);
                }
    ...
    public class UnityEngineFogModeWrap
    {
		public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginClassRegister(typeof(UnityEngine.FogMode), L, null, 5, 0, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.FogMode));
			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
    ...
    public class UnityEngineLightmapsModeWrap
    {
		public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginClassRegister(typeof(UnityEngine.LightmapsMode), L, null, 8, 0, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "SeparateDirectional", UnityEngine.LightmapsMode.SeparateDirectional);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.LightmapsMode));
			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
				...
				else if (LuaAPI.xlua_is_eq_str(L, 1, "SeparateDirectional"))
                {
                    translator.PushUnityEngineLightmapsMode(L, UnityEngine.LightmapsMode.SeparateDirectional);
                }
				else
                {
    ...
    public class UnityEngineAnimatorCullingModeWrap
    {
		public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginClassRegister(typeof(UnityEngine.AnimatorCullingMode), L, null, 6, 0, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.AnimatorCullingMode));
			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
    ...
    public class UnityEngineRenderTextureFormatWrap
    {
		public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginClassRegister(typeof(UnityEngine.RenderTextureFormat), L, null, 21, 0, 0);
    ...
    public class UnityEngineRenderTextureReadWriteWrap
    {
		public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginClassRegister(typeof(UnityEngine.RenderTextureReadWrite), L, null, 5, 0, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.RenderTextureReadWrite));
			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
    ...
    public class UnityEngineCollisionFlagsWrap
    {
		public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginClassRegister(typeof(UnityEngine.CollisionFlags), L, null, 9, 0, 0);
            ...
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.CollisionFlags));
			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
