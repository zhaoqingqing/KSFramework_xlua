...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRaycastHitWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.RaycastHit), L, translator, 0, 0, 11, 4);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.RaycastHit), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.RaycastHit), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.RaycastHit));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.RaycastHit), L, translator);
        }
