...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEnginePhysicsWrap
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(typeof(UnityEngine.Physics), L, __CreateInstance, 27, 6, 6);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "solverIterationCount", _g_get_solverIterationCount);
            ...
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "solverIterationCount", _s_set_solverIterationCount);
        ...
        static int _g_get_solverIterationCount(RealStatePtr L)
        {
            ...
            try {
			    LuaAPI.xlua_pushinteger(L, UnityEngine.Physics.solverIterationCount);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_solverIterationCount(RealStatePtr L)
        {
            ...
            try {
			    UnityEngine.Physics.solverIterationCount = LuaAPI.xlua_tointeger(L, 1);
