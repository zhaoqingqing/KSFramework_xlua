...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineGameObjectWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "HasRigidbody", _m_HasRigidbody);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "HasAnimation", _m_HasAnimation);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_HasRigidbody(RealStatePtr L)
        {
            ...
            try {
                
                {
                        ...
                        bool __cl_gen_ret = __cl_gen_to_be_invoked.HasRigidbody(  );
                        LuaAPI.lua_pushboolean(L, __cl_gen_ret);
        ...
        static int _m_HasAnimation(RealStatePtr L)
        {
            ...
            try {
                
                {
                        ...
                        bool __cl_gen_ret = __cl_gen_to_be_invoked.HasAnimation(  );
                        LuaAPI.lua_pushboolean(L, __cl_gen_ret);
