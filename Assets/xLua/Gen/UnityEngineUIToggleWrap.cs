...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineUIToggleWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.UI.Toggle), L, translator, 0, 5, 5, 5);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.UI.Toggle), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.UI.Toggle), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.UI.Toggle));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.UI.Toggle), L, translator);
        }
        ...
        static int _g_get_toggleTransition(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.UI.Toggle __cl_gen_to_be_invoked = (UnityEngine.UI.Toggle)translator.FastGetCSObj(L, 1);
                translator.Push(L, __cl_gen_to_be_invoked.toggleTransition);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
