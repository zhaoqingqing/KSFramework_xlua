...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAnimatorStateInfoWrap
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.AnimatorStateInfo), L, translator, 0, 2, 8, 0);
			...
			Utils.EndObjectRegister(typeof(UnityEngine.AnimatorStateInfo), L, translator, null, null,
			    null, null, null);

		    Utils.BeginClassRegister(typeof(UnityEngine.AnimatorStateInfo), L, __CreateInstance, 1, 0, 0);
			
			
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "UnderlyingSystemType", typeof(UnityEngine.AnimatorStateInfo));
			
			
			Utils.EndClassRegister(typeof(UnityEngine.AnimatorStateInfo), L, translator);
        }
        ...
        static int _m_IsName(RealStatePtr L)
        {
            ...
            UnityEngine.AnimatorStateInfo __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
            ...
            try {
                
                {
                    string tag = LuaAPI.lua_tostring(L, 2);
                        ...
                        bool __cl_gen_ret = __cl_gen_to_be_invoked.IsTag( tag );
                        LuaAPI.lua_pushboolean(L, __cl_gen_ret);
        ...
        static int _g_get_shortNameHash(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.AnimatorStateInfo __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                LuaAPI.xlua_pushinteger(L, __cl_gen_to_be_invoked.shortNameHash);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_speedMultiplier(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.AnimatorStateInfo __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                LuaAPI.lua_pushnumber(L, __cl_gen_to_be_invoked.speedMultiplier);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _g_get_tagHash(RealStatePtr L)
        {
            ...
            try {
                ...
                UnityEngine.AnimatorStateInfo __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                LuaAPI.xlua_pushinteger(L, __cl_gen_to_be_invoked.tagHash);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
